...
import { colorFor, radiusPropsFor } from './nodeStyle';

export { colorFor, radiusPropsFor };
 ...
 */
export function buildNodesLayer({ nodes, spaceMode, hoveredId = null, selectedId = null, onHover, onClick }) {
    return new ScatterplotLayer({
        ...
        stroked: true,
        getLineColor: (n) => (n.id === selectedId ? [255, 255, 255, 255] : [0, 0, 0, 0]),
