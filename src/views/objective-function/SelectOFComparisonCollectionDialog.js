...
const SelectOFComparisonCollectionDialog = ({ isOpen, onClose, problemInstanceId, onSelect }) => {
    ...
    const handleSelect = () => {
        onSelect(selectedOFComparisonCollection);
    };
    ...
    return (
        <Dialog open={isOpen} onClose={handleClose} fullWidth={true} maxWidth={'lg'}>
            ...
            <DialogContent>
                ...
                <OFComparisonCollectionTable
                    isOpen={true}
                    problemInstanceId={problemInstanceId}
                    setSelected={setSelectedOFComparisonCollection}
                />
...
export default SelectOFComparisonCollectionDialog;
